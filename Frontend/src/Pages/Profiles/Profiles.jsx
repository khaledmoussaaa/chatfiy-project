    ...
    return (
        <div className='w-full h-full py-5'>
            <div className='w-[50%] mx-auto h-80 relative'>
                <img src='/src/assets/images/42.jpg' className='absolute w-full h-full object-cover rounded-3xl' alt="Background" />
                <img src='/src/assets/images/Profile.png' className='absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-10 w-28 h-28' alt="Profile" />
            </div>
